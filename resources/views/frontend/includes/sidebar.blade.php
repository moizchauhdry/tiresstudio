    ...
    <div class="widget dark-widget clearfix">
        <div class="inner-addon right-addon">
            ...
            <input type="text" class="form-control" id="search" placeholder="Search"
                onkeyup="getResults('{{ URL::current() }}')">
        </div>
    </div><!-- end widget -->
    ...
    <div class="widget clearfix">
        <div class="search-tab clearfix">
            ...
            <ul class="nav nav-tabs search-tab-nav" role="tablist">
                @if($response['type'] == 'Wheel') <li role="presentation" class="active"><a href="#tab01" role="tab"
                        data-toggle="tab">Wheels</a></li> @endif
                @if($response['type'] == 'Tire') <li role="presentation" class="active"><a href="#tab02" role="tab"
                        data-toggle="tab">Tires</a></li> @endif
                @if($response['type'] == 'ACC') <li role="presentation" class="active"><a href="#tab03" role="tab"
                        data-toggle="tab">Accessories</a></li> @endif
                @if($response['type'] == 'SHOP') <li role="presentation" class="active"><a href="#tab03" role="tab"
                        data-toggle="tab">Shop</a></li> @endif
            </ul>
                    ...
                    <div class="search-wrapper">
                        <form class="row" action="" id="sidebarForm" onsubmit="this.preventDefault()">
                            ...
                            <input type="text" hidden name="year" id="year"
                                value="{{ isset($response['filter']['year']) ? $response['filter']['year'] : '' }}">
                            <input type="text" hidden name="make" id="make"
                                value="{{ isset($response['filter']['make']) ? $response['filter']['make'] : '' }}">
                            <input type="text" hidden name="model" id="model"
                                value="{{ isset($response['filter']['model']) ? $response['filter']['model'] : '' }}">

                            <div class="col-md-12 col-xs-12">
                                <button class="btn btn-primary btn-block" type="button"
                                    onclick="getResults('{{ route('frontend.pages.wheels') }}')">FILTER WHEELS</button>
                                <a href="javascript:void(0)" onclick="resetAll()" class="customa"><i
                                        class="fa fa-refresh"></i> Reset all</a>
                            </div><!-- end col -->
                        </form><!-- end row -->
                ...
                <div role="tabpanel" class="tab-pane in active" id="tab02">
                    <div class="search-wrapper">
                        <form class="row" action="" id="sidebarForm" onsubmit="this.preventDefault()">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <button class="btn btn-primary btn-block" type="button"
                                    onclick="getResults('{{ route('frontend.pages.tires') }}')">FILTER TIRES</button>
                                <a href="javascript:void(0)" onclick="resetAll()" class="customa"><i
                                        class="fa fa-refresh"></i> Reset all</a>
                            </div><!-- end col -->
                        </form>
                ...
                <div role="tabpanel" class="tab-pane in active" id="tab03">
                    <div class="search-wrapper">
                        <form class="row" action="" id="sidebarForm" onsubmit="this.preventDefault()">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <button class="btn btn-primary btn-block" type="button"
                                    onclick="getResults('{{ route('frontend.pages.accessories') }}')">FILTER
                                    ACCESSORIES</button>
                                <a href="javascript:void(0)" onclick="resetAll()" class="customa"><i
                                        class="fa fa-refresh"></i> Reset all</a>
                            </div><!-- end col -->
                ...
                <div role="tabpanel" class="tab-pane in active" id="tab03">
                    <div class="search-wrapper">
                        <form class="row" action="" id="sidebarForm" onsubmit="this.preventDefault()">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <button class="btn btn-primary btn-block" type="button"
                                    onclick="getResults('{{ route('frontend.pages.shop') }}')">FILTER SHOP</button>
                                <a href="javascript:void(0)" onclick="resetAll()" class="customa"><i
                                        class="fa fa-refresh"></i> Reset all</a>
                            </div><!-- end col -->
                        </form>
